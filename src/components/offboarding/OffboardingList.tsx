...
import { Plus, Search, Filter, LogOut, Calendar, Package, AppWindow } from 'lucide-react';
...
const MOCK_EMPLOYEES: OffboardingEmployee[] = [
  {
    id: '1',
    name: 'John Smith',
...
export default function OffboardingList() {
  ...
  const getStatusBadge = (status: OffboardingEmployee['status']) => {
    switch (status) {
      case 'completed':
        return (
      ...
      <div className="bg-white rounded-xl shadow-sm">
        ...
        <div className="px-8 py-6 border-b border-gray-200">
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">Employee Offboarding</h1>
              <p className="mt-1 text-sm text-gray-500">
                Manage and track employee offboarding processes
              </p>
            </div>
            <button
